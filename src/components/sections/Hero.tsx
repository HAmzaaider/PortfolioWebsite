  ...
  return (
    ...
    >
        ...
        >
          ...
          <motion.div variants={itemVariants} className="mb-8">
            <span className="
              ...
              bg-mustard-500/10 border border-mustard-600/25
          ...
          <motion.p
            ...
            className="font-mono text-sm text-navy-600/60 tracking-widest mb-4"
          >
            Hello, I'm
          </motion.p>
          ...
          <motion.p
            variants={itemVariants}
            className="
              text-navy-800/60 text-base md:text-lg
          ...
          >
            ...
            <a
              ...
              className="
                ...
                hover:shadow-[0_6px_28px_rgba(217,119,6,0.5)]
              "
            >
          ...
          >
            <span className="font-mono text-xs text-navy-600/40 tracking-widest">
              FIND ME
            </span>
      ...
      <motion.div
        ...
        "
      >
        <span className="font-mono text-xs text-navy-800/30 tracking-widest">
          SCROLL
        </span>
